...
def main():
    ...
    # Only th lx variable was modified by the modify_args function. 
    # The variable x does not change because it is an integer and 
    # is therefore passed by the computer as a value, whereas 
    # the list lx was passed by the computer as a reference.
